...
if (isset($_POST['submit'])) {
    ...
    if ($img1 != '' || $img2 != '' || $img3 != '' || $img4 != '' || $img5 != '') {
        $sql = "SELECT * FROM `users` WHERE `_useremail` = '$useremail' AND `_userpassword` = '$userpassword' AND `_img1` = '$img1' AND `_img2` = '$img2' AND `_img3` = '$img3' AND `_img4` = '$img4' AND `_img5` = '$img5'   ";
        ...
        if ($query) {
            ...
            if ($count >= 1) {
                echo "<script>
                   alert('Congratulations ! Succeed in Finding Your Account.. Click on OK button to continue..');
                    ...
                    <div class="col-lg-8 mx-auto">
                        ...
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            ...
                            <center><a class="navbar-brand" href="#myPage" style="font-size:20px; color:#C94B4B";><b>Graphical Password Autentication<b></a></center>
                                <p><center><b> Sign In to your Account..</b></center>
                            <!--<img src="images/lock6.png" height="50px"  alt="logo">-->
                            ...
                            <form class="pt-3" method="POST" action="">
                                ...
                                <div class="text-center mt-4 font-weight-light">
                                    Don't have an account? <a href="./_register.php" class="text-primary">Create</a>
                                </div>
                            </form>
                        </div>
                    </div>
